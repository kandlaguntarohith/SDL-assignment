...
public class User {
    ...
    private Vector<Integer> currentLendBooks = new Vector<Integer>();
    private Queue<Integer> bookLendHistory = new LinkedList<>();
    private Vector<Integer> waitListUpdates = new Vector<>();
